...
// themes.ts
var darkPalette = ["hsla(327, 73%, 1%, 1)", "hsla(327, 73%, 6%, 1)", "hsla(327, 73%, 12%, 1)", "hsla(327, 73%, 17%, 1)", "hsla(327, 73%, 23%, 1)", "hsla(327, 73%, 28%, 1)", "hsla(327, 73%, 34%, 1)", "hsla(327, 73%, 39%, 1)", "hsla(327, 73%, 45%, 1)", "hsla(327, 73%, 50%, 1)", "hsla(0, 15%, 93%, 1)", "hsla(0, 15%, 99%, 1)"];
var lightPalette = ["hsla(327, 73%, 97%, 1)", "hsla(327, 73%, 92%, 1)", "hsla(327, 73%, 87%, 1)", "hsla(327, 73%, 81%, 1)", "hsla(327, 73%, 76%, 1)", "hsla(327, 73%, 71%, 1)", "hsla(327, 73%, 66%, 1)", "hsla(327, 73%, 60%, 1)", "hsla(327, 73%, 55%, 1)", "hsla(327, 73%, 50%, 1)", "hsla(0, 15%, 15%, 1)", "hsla(0, 15%, 1%, 1)"];
var lightShadows = {
